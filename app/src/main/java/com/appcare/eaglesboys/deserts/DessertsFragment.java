...
public class DessertsFragment extends CommonFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View mpastaView = inflater.inflate(R.layout.fragment_beverages, null);
    ...
    private void initPastaViews(View mpastaView) {
        ...
        HttpHandler.sendRequest("dessert_api/list", mResponseHandler, "beverages");
    }
    ...
    public void handleResponse(Object response, String tag) {
        ...
        try {
            ...
            JSONArray jsonarray = mJSObject.getJSONArray("Dips");
